...
const options = {
  ...
  CWMP_LOG_FILE: { type: "path", default: "/var/log/genieacs/genieacs-cwmp.log" },
  CWMP_ACCESS_LOG_FILE: { type: "path", default: "/var/log/genieacs/genieacs-cwmp-access.log" },
  ...
  NBI_LOG_FILE: { type: "path", default: "/var/log/genieacs/genieacs-nbi.log" },
  NBI_ACCESS_LOG_FILE: { type: "path", default: "/var/log/genieacs/genieacs-nbi-access.log" },
  ...
  FS_URL_PREFIX: { type: "string", default: "http://acs2.e-freewifi.com/fs/" },
  ...
  CONNECTION_REQUEST_ALLOW_BASIC_AUTH: { type: "bool", default: true },
